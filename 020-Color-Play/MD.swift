...
public class MD {
    public let red: [String: Color]!
    public let pink: [String: Color]!
    public let purple: [String: Color]!
    public let deep_purple: [String: Color]!
    public let indigo: [String: Color]!
    public let blue: [String: Color]!
    public let light_blue: [String: Color]!
    public let cyan: [String: Color]!
    public let teal: [String: Color]!
    public let green: [String: Color]!
    public let light_green: [String: Color]!
    public let lime: [String: Color]!
    public let yellow: [String: Color]!
    public let amber: [String: Color]!
    public let orange: [String: Color]!
    public let deep_orange: [String: Color]!
    public let brown: [String: Color]!
    public let grey: [String: Color]!
    public let blue_grey: [String: Color]!
    
    public let totalMDDict: [String: [String: Color]]!
    
    public let totalColorNumber = 256
    public let totalPrimaryColorNumber = 19
    public let totalSubColorNumber = 14
    ...
    public func randomPrimary() -> Color {
    ...
    //return a random sub color
     public func random(primaryColor: String) -> Color{
        
        let colorArray = totalMDDict[primaryColor]!.toArray{$1}
        return colorArray[Int.random(colorArray.count)]
    }
    
    public func randomLight() -> Color {
